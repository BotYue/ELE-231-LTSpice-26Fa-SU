...
| [2. 4R Circuit](Problem_2_4R.md) | Know different circuit symbols | 4 | Current plot + max current value (A) |
| [3. RLC](Problem_3_RLC.md) | Calculate balanced bridge value, verify zero current | 6 | Calculation + schematic + current plot |
